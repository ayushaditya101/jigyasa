...
<body>
  ...
  <div id="wrapper">
    ...
    <section id="content">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3578.47775247407!2d81.23757581478135!3d26.246153594784683!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399ba1580a0c426f%3A0xb6a9d03167a4582!2sFGIET+Academic+Block!5e0!3m2!1sen!2sin!4v1554803654147!5m2!1sen!2sin" width="100%" height="380" frameborder="0" style="border:0" allowfullscreen></iframe>
      <div class="container">
        <div class="row">
          <div class="span8">
            ...
            <form name= "contact_form" action="contact1.jsp" method="post" role="form" class="contactForm">
              <div class="row">
                ...
                <div class="span8 form-group">
                  ...
                  <div class="text-center">
                    <button class="btn btn-theme btn-medium margintop10" type="button" onclick="submitForm()">Send a message</button>
                  </div>
                </div>
              </div>
            </form>
            ...
            <aside class="right-sidebar">
              ...
              <div class="widget">
                ...
                <ul class="contact-info">
                  <li><label>Address :</label> FGIET, Lucknow road, near Ratapur chauraha<br /> Raebareli</li>
                  <li><label>Phone :</label>+91 818 283 0425 / +91 741 766 1500 / +91 830 350 7005 / +91 870 786 4107</li>
              
                  <li><label>Email : </label> a3gs@gmail.com</li>
                </ul>
