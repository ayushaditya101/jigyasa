  ...
  <section id="container" class="">
   ...
   <a onclick="myFunction()"><img src="img/logo.png" alt="" /></a>
    ...
    <section id="main-content">
  	...
  	/*execute query*/
     rs=stmt.executeQuery("SELECT MAX(`qid`) FROM `genawq`");
	rs.next();
	max_id=rs.getInt(1);   
	
	rs=stmt.executeQuery("SELECT MIN(`qid`) FROM `genawq`");
...
try{
	%>
	<form name="genaw_quiz" action="resultcheck.jsp">
...
function submitForm() {
	   ...
	   var frm = document.getElementsByName('genaw_quiz')[0];
