  ...
  <section id="container" class="">
   ...
   <a onclick="myFunction()"><img src="img/logo.png" alt="" /></a>
    ...
    <section id="main-content">
  	...
  	/*execute query*/
     rs=stmt.executeQuery("SELECT MAX(`qid`) FROM `jeeq`");
	rs.next();
	max_id=rs.getInt(1);   
	
	rs=stmt.executeQuery("SELECT MIN(`qid`) FROM `jeeq`");
...
try{
	%>
	<form name="jee_quiz" action="resultcheck.jsp">
	...
	%>	
	<input type="hidden" name="subject" value="jee" readonly="readonly" />
...
function submitForm() {
	   ...
	   var frm = document.getElementsByName('jee_quiz')[0];
