  ...
  <section id="container" class="">
   ...
   <a onclick="myFunction()"><img src="img/logo.png" alt="" /></a>
    ...
    <section id="main-content">
  	...
  	/*execute query*/
     rs=stmt.executeQuery("SELECT MAX(`qid`) FROM `genscq`");
	rs.next();
	max_id=rs.getInt(1);   
	
	rs=stmt.executeQuery("SELECT MIN(`qid`) FROM `genscq`");
...
try{
	%>
	<form name="gensc_quiz" action="resultcheck.jsp">
...
function submitForm() {
	   ...
	   var frm = document.getElementsByName('gensc_quiz')[0];
