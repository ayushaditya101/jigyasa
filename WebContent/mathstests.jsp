  ...
  <section id="container" class="">
   ...
   <a onclick="myFunction()"><img src="img/logo.png" alt="" /></a>
    ...
    <section id="main-content">
  	...
  	/*execute query*/
     rs=stmt.executeQuery("SELECT MAX(`qid`) FROM `mathsq`");
	rs.next();
	max_id=rs.getInt(1);   
	
	rs=stmt.executeQuery("SELECT MIN(`qid`) FROM `mathsq`");
...
try{
	%>
	<form name="maths_quiz" action="resultcheck.jsp">
	...
	%>	
	<input type="hidden" name="subject" value="maths" readonly="readonly" />
...
function submitForm() {
	   ...
	   var frm = document.getElementsByName('maths_quiz')[0];
