...
<body
	style="background-image: url(img/adminwall.jpg); -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
	...
	<div class="container">
		...
		<form name="contact_form" class="login-form" action="adminlogin1.jsp">
			...
			<div class="login-wrap">
			 ...
			 <a href = "adminforgotpassword.jsp" style="text-decoration:none;"><button class="btn btn-success btn-lg btn-block">Forgot password??</button></a>
   	<button class="btn btn-theme btn-block" type="button"
			   ...
			   <a href="signup.jsp" style="text-decoration:none;"><button class="btn btn-info btn-lg btn-block" >Signup</button></a>
				...
				<div class="panel panel-danger">
					<div class="panel-heading">Incorrect username or password...</div>
