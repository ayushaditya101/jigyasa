  ...
  <section id="container" class="">
   ...
   <a onclick="myFunction()"><img src="img/logo.png" alt="" /></a>
    ...
    <section id="main-content">
  	...
  	/*execute query*/
     rs=stmt.executeQuery("SELECT MAX(`qid`) FROM `englishq`");
	rs.next();
	max_id=rs.getInt(1);   
	
	rs=stmt.executeQuery("SELECT MIN(`qid`) FROM `englishq`");
...
try{
	%>
	<form name="english_quiz" action="resultcheck.jsp">
...
function submitForm() {
	   ...
	   var frm = document.getElementsByName('english_quiz')[0];
